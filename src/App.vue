...
<template>
  ...
  <main v-else class="app-shell">
    ...
    <section v-if="tab === 'home'" class="page home-page">
      ...
      <div class="metrics home-grid"><MetricCard :value="formatMoney(store.moneySaved)" label="сэкономлено" tone="green"/><MetricCard :value="Math.floor(store.cigarettesNotSmoked).toLocaleString('ru-RU')" label="не выкурено" tone="blue"/><MetricCard :value="`${store.smokeFreeRatio}%`" label="чистых дней" tone="purple"/></div>
