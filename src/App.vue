...
import CigaretteJar from './components/CigaretteJar.vue'
...
<template>
  ...
  <main v-else class="app-shell">
    <AppHeader :title="tab === 'home' ? 'Сегодня без дыма' : ({ health: 'Здоровье', finance: 'Финансы', volume: 'Объём', history: 'История' }[tab] || '')" @settings="settingsOpen = true"/>
