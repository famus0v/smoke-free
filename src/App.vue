...
import { AlertTriangle, Wind, CigaretteOff, Trophy, BriefcaseBusiness, Coffee, Heart, BadgeDollarSign, TrendingUp, CalendarDays, ReceiptText } from 'lucide-vue-next'
...
<template>
  ...
  <main v-else class="app-shell">
    ...
    <section v-if="tab === 'home'" class="page">
      ...
      <div class="action-row"><button class="quick-action" @click="cravingOpen = true; impact()"><Wind :size="19"/>Записать тягу</button><button class="quick-action muted-action" @click="slipOpen = true; impact('light')"><AlertTriangle :size="18"/>Я оступился</button></div>
